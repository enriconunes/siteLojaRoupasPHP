...
$url = "http://localhost/PHP_MySql_Projetos/nativos_v2/pags/apis.php/product_id" . "?id=" . $_GET["id"];
    ...
    <div id="container">
        ...
        <div id="user-container">
            <div class="menu-user">
                ...
                <form method="POST" action="APIs.php/edit_product?id=<?=$_GET['id']?>" style="margin: 0 auto;">
                    <?php
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id" name="id" value="<?= $product_data['id'] ?>" disabled>
                        </div>
                        <!-- name -->
                        <div class="form-group">
                            <label for="name">Nome</label>
                            <input type="text" class="form-control" id="name" name="name" value="<?= $product_data['name'] ?>" required>
                        </div>
                        <!-- price -->
                        <div class="form-group">
                            <label for="price">Preço</label>
                            <input type="number" step=".01" class="form-control" name="price" id="price" value="<?= $product_data['price'] ?>" required>
                        </div>
                        <!-- type -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="image" class="form-control" id="image" value="<?= $product_data['image'] ?>" required>
                        </div>
